...
class BazelCli(Cli): 
    ...
    def _set_install_qt_parser(self, install_qt_parser, *args, **kwargs):
        ...
        install_qt_parser.add_argument(
            "--bzl-config-out",
            help="Path to where to write the bazel config .bzl file.",
        )

    # Make a new function that can only generate the urls & hashes in a .bzl file
